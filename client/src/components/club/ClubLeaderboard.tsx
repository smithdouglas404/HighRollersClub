          ...
          entries.map((entry, i) => {
            ...
            return (
              <motion.div
                ...
                className="grid grid-cols-12 gap-2 items-center px-5 py-2.5 border-b border-white/[0.03] hover:bg-amber-500/[0.06] transition-all"
              >
                {/* Rank */}
                ...
                <div className="col-span-5 text-right">
                  <span className={`text-sm font-bold font-mono ${rank <= 3 ? "text-amber-400" : "text-white"}`}>
