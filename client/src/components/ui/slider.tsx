  ...
  >
    <SliderPrimitive.Track
      ...
      style={{
        ...
        boxShadow: "inset 0 2px 4px rgba(0,0,0,0.4), 0 0 6px rgba(212,175,55,0.08)",
      }}
    >
      <SliderPrimitive.Range
        className="absolute h-full rounded-full"
        style={{
          background: "linear-gradient(90deg, #0891b2, #06b6d4, #22d3ee, #d4af37)",
          boxShadow: "0 0 12px rgba(212,175,55,0.4), 0 0 4px rgba(212,175,55,0.2)",
        }}
      />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb
      ...
      style={{
        ...
        boxShadow: "0 2px 10px rgba(0,0,0,0.5), 0 0 14px rgba(212,175,55,0.3), inset 0 1px 2px rgba(255,255,255,0.4)",
      }}
    />
  </SliderPrimitive.Root>
))
