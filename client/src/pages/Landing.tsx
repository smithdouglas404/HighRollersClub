  ...
  return (
    <div className="min-h-screen bg-[#020508] text-white font-sans relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "repeating-linear-gradient(0deg, transparent 0px, transparent 3px, rgba(0,255,157,0.012) 3px, rgba(0,255,157,0.012) 4px)",
        }}
      />
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 relative">
              ...
              <img src={lionLogo} alt="Logo" className="w-full h-full object-contain relative z-10 drop-shadow-[0_0_12px_rgba(201,168,76,0.5)]" />
            </div>
            <div className="flex flex-col">
              <span className="font-display font-bold text-sm tracking-[0.25em] gold-text leading-none">HIGH ROLLERS</span>
              <span className="text-[8px] text-gray-600 tracking-[0.3em] font-mono mt-0.5">POKER PLATFORM</span>
            </div>
          </div>

          <div className="flex items-center gap-5">
            <Link href="/lobby">
              <span className="text-[11px] text-gray-400 uppercase tracking-wider font-semibold hidden md:block cursor-pointer hover:text-cyan-400 transition-colors">Clubs</span>
            </Link>
            <span className="text-[11px] text-gray-500 uppercase tracking-wider font-semibold hidden md:block cursor-not-allowed">Leagues</span>
            <span className="text-[11px] text-gray-500 uppercase tracking-wider font-semibold hidden md:block cursor-not-allowed">Provably Fair</span>
            <Link href="/lobby">
              <button className="glass rounded-lg px-5 py-2.5 text-[11px] font-bold uppercase tracking-wider text-cyan-400 border border-cyan-500/20 hover:bg-cyan-500/10 transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(0,240,255,0.08)]">
        ...
        <div className="flex-1 flex items-center px-6 md:px-10 lg:px-16 py-8">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="absolute left-[42%] top-0 bottom-0 w-px bg-gradient-to-b from-transparent via-cyan-500/10 to-transparent -skew-x-12 hidden lg:block" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                  ...
                  <Link href="/lobby">
                    <button
                      ...
                      style={{
                        ...
                        boxShadow: "0 0 40px rgba(0,255,157,0.3), 0 0 80px rgba(0,255,157,0.08), inset 0 1px 0 rgba(255,255,255,0.3)",
                      }}
                    >
              ...
              <div className="lg:col-span-7 relative h-[550px] flex items-center justify-center">
                ...
                <motion.div
                  ...
                  style={{ border: "1px solid rgba(0,240,255,0.12)", boxShadow: "0 20px 60px rgba(0,0,0,0.5), 0 0 25px rgba(0,240,255,0.04)" }}
                >
                  ...
                  <div className="aspect-[4/3] relative bg-[#0a1218]">
                    ...
                    {/* Mini chip stack */}
                    <img src={chipStack} alt="" className="absolute bottom-4 right-4 w-14 h-14 object-contain opacity-80 drop-shadow-[0_0_10px_rgba(201,168,76,0.3)]" />
                    <div className="absolute bottom-3 left-3">
                      <div className="text-[9px] text-gray-500 uppercase tracking-wider">High Stakes NLH</div>
                ...
                <motion.div
                  ...
                  style={{ border: "1px solid rgba(0,255,157,0.12)", boxShadow: "0 20px 60px rgba(0,0,0,0.5), 0 0 25px rgba(0,255,157,0.04)" }}
                >
                  <div className="flex items-center justify-between p-3 border-b border-white/5">
                    ...
                    <div className="text-[8px] font-mono text-green-400/50">SHA-256</div>
                  </div>
                  <div className="aspect-[16/9] relative bg-black/60">
                    <div
                      className="absolute inset-0 z-10 pointer-events-none"
                      style={{ background: "repeating-linear-gradient(0deg, transparent 0px, transparent 2px, rgba(0,255,157,0.03) 2px, rgba(0,255,157,0.03) 4px)" }}
                    />
                    <img src={entropyHud} className="w-full h-full object-cover opacity-70 mix-blend-screen" alt="Entropy" />
                    <div className="absolute top-3 right-3 flex flex-col items-end gap-1">
                      <div className="text-[8px] font-mono text-green-400/60">VERIFIED ✓</div>
                      <div className="text-[8px] font-mono text-green-400/40">BLOCK #892,101</div>
                    </div>
                    <div className="absolute bottom-3 left-3">
                      <div className="text-[8px] text-gray-600 font-mono">Fisher-Yates + Chainlink VRF</div>
                    </div>
                  </div>
                </motion.div>
                ...
                <motion.div
                  ...
                  style={{ border: "1px solid rgba(0,255,157,0.15)", boxShadow: "0 0 40px rgba(0,255,157,0.06), 0 20px 40px rgba(0,0,0,0.4)" }}
                >
                  ...
                  <div>
                    <div className="text-[9px] text-gray-500 font-bold uppercase tracking-wider">Blockchain Verified</div>
                    <div className="text-base font-bold text-white leading-tight">Provably Fair</div>
                    <div className="text-[9px] text-gray-600 font-mono mt-0.5">Every shuffle. Every hand.</div>
                  </div>
                </motion.div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-4 opacity-50">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px] text-gray-500 font-semibold">iOS & Android</span>
              </div>
