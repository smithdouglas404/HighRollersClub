...
import {
  ...
  Zap, BookOpen, Wallet, Users, Loader2, Edit
} from "lucide-react";
          ...
          <div className="relative z-10 flex items-center gap-6">
            <div className="relative">
              <MemberAvatar
                ...
                size="lg"
              />
              <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-green-400 border-2 border-[#0a0a1a] shadow-[0_0_6px_rgba(74,222,128,0.6)]" />
            </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center p-4 rounded-lg bg-white/5 border border-cyan-500/10">
                ...
                <div className="text-[9px] text-gray-500 uppercase tracking-wider mt-1">Hands Played</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/5 border border-green-500/10">
                ...
                <div className="text-[9px] text-gray-500 uppercase tracking-wider mt-1">Pots Won</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/5 border border-amber-500/10">
                ...
                <div className="text-[9px] text-gray-500 uppercase tracking-wider mt-1">Win Rate</div>
              </div>
              <div className="text-center p-4 rounded-lg bg-white/5 border border-purple-500/10">
                ...
                <div className="text-[9px] text-gray-500 uppercase tracking-wider mt-1">Best Streak</div>
              </div>
            </div>
          )}
