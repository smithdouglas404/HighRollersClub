      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <h2 className="text-xs font-display font-bold text-gray-300 uppercase tracking-widest">
              Connected Wallets
            </h2>
        ...
        <div className="flex items-center gap-2">
          {connectedCount > 0 && (
            <span className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-green-500/10 border border-green-500/20">
              ...
              <span className="text-[0.5rem] font-bold text-green-400 uppercase">{connectedCount} Active</span>
            </span>
          )}
          <motion.div
        ...
        {expanded && (
          ...
          >
            <div className="px-5 sm:px-6 pb-5 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {WALLET_PROVIDERS.map((provider) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        {/* Provider icon (letter placeholder) */}
                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 font-display font-bold text-base ${provider.bgColor} ${provider.color} border ${provider.borderColor}`}>
                          {provider.letter}
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2">
                            <p className={`text-xs font-bold ${isConnected ? "text-white" : "text-gray-300"}`}>
                              {provider.name}
                            </p>
                            {isConnected && (
                          ...
                          {isConnected && address ? (
                            <p className="text-[0.625rem] text-gray-500 font-mono mt-0.5 truncate">
                              {truncateWalletAddress(address)}
                            </p>
                          ) : (
                            <p className="text-[0.5625rem] text-gray-600 mt-0.5">Not connected</p>
                          )}
                        </div>
                        ...
                        <div className="shrink-0">
                          {isConnecting ? (
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[0.5625rem] font-bold uppercase tracking-wider text-red-400 bg-red-500/10 border border-red-500/20 hover:bg-red-500/20 hover:border-red-500/30 transition-all"
                            >
                            ...
                            <button
                              ...
                              className="flex items-center gap-1 px-3 py-1.5 rounded-lg text-[0.5625rem] font-bold uppercase tracking-wider text-primary bg-primary/10 border border-primary/20 hover:bg-primary/20 hover:border-primary/30 transition-all"
                            >
              ...
              {/* Security notice */}
              <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-green-500/5 border border-green-500/10">
  ...
  return (
    <DashboardLayout title="Wallet">
      ...
      <div className="px-4 sm:px-8 pb-8 space-y-6 max-w-6xl mx-auto relative z-10">
        ...
        {/* ── Connected Wallets (Provider Connections) ────────────────── */}
