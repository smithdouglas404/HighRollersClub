...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", "data:", "blob:", "*.googleapis.com", "*.onfido.com"],
      connectSrc: ["'self'", "*.firebaseapp.com", "*.googleapis.com", "*.onfido.com", "*.daily.co", "wss:", "ws:"],
      frameSrc: ["'self'", "*.onfido.com", "*.daily.co", "*.firebaseapp.com"],
